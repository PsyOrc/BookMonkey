...
exports.fileIcons = {
    ...
    icons: [
        ...
        { name: 'react_ts', fileExtensions: ['tsx'] },
        {
            ...
            enabledFor: [index_1.IconPack.Angular, index_1.IconPack.Ngrx, index_1.IconPack.React, index_1.IconPack.Redux]
        },
        {
            name: 'redux-action',
        ...
        { name: 'angular-guard', fileExtensions: ['guard.ts', 'guard.js'], enabledFor: [index_1.IconPack.Angular, index_1.IconPack.Ngrx] },
        { name: 'angular-service', fileExtensions: ['service.ts', 'service.js'], enabledFor: [index_1.IconPack.Angular, index_1.IconPack.Ngrx] },
        {
            name: 'angular-pipe',
        ...
        { name: 'ngrx-reducer', fileExtensions: ['reducer.ts', 'rootReducer.ts'], enabledFor: [index_1.IconPack.Ngrx] },
        { name: 'ngrx-state', fileExtensions: ['state.ts'], enabledFor: [index_1.IconPack.Ngrx] },
        { name: 'ngrx-actions', fileExtensions: ['actions.ts'], enabledFor: [index_1.IconPack.Ngrx] },
        { name: 'ngrx-effects', fileExtensions: ['effects.ts'], enabledFor: [index_1.IconPack.Ngrx] },
        { name: 'ngrx-entity', fileNames: ['.entity'], enabledFor: [index_1.IconPack.Ngrx] },
